...
for(i = 0; i < productsArr.length; i++){
  output += ` <div class="row">
        <div class="col-md-4">
          <div class="card">
            <div class="thumbnail">
              <img src="${productsArr[i].img}">
              </div>
              <div class="contents">
                <h3 class="name">${productsArr[i].product}</h3>
                <p class="price">${productsArr[i].price}</p>
                <p class="description">${productsArr[i].unit}</p>
            </div>
          </div>
        </div>
        <div class="col-md-4">
          <div class="card">
            ...
            <div class="contents">
              <h3>${productsArr[i].product}</h3>
              <p>${productsArr[i].price}</p>
              <p>${productsArr[i].unit}</p>
            </div>
          </div>
        </div>
        <div class="col-md-4">
